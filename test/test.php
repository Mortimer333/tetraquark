...
// $minified = $tetra->minify(__DIR__ . '/data/caller.js'); echo PHP_EOL . PHP_EOL . $minified . PHP_EOL;
...
$minified = $tetra->minify('E:\xampp\htdocs\tab_jf\main.js'); echo PHP_EOL . PHP_EOL . $minified . PHP_EOL;
